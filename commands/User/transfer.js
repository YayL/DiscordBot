        ...
        try{
            ...
            if(amount == false) 
                return client.msg.reply(msg, 'XP Conversion',
                 `You can convert $${client.utils.fixNumber(totalBal, true)} into ${client.utils.fixNumber(Math.floor((totalBal*xpRate)/moneyRate))}xp`, disc);
            ...
            if(amount == 0) 
                return client.msg.reply(msg, `Too small amount!`, `The amount specified requires to be above $${client.utils.fixNumber(moneyRate)}`, disc);
