module.exports = {
	...
	run: async function(msg, client, disc, args){
		try{
			...
			const gang_template_keys = Object.keys(client.s.GANG_INFO_TEMPLATE), gang_template_values = Object.values(client.s.GANG_INFO_TEMPLATE)
			const gang_template_settings_keys = Object.keys(client.s.GANG_INFO_TEMPLATE.SETTINGS), gang_template_settings_values = Object.values(client.s.GANG_INFO_TEMPLATE.SETTINGS)
