...
pool.connect((e, client) => {
    ...
    client.query("CREATE TABLE rules(id INT NOT NULL PRIMARY KEY, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, corelaw SMALLINT NOT NULL, rule_date TIMESTAMP WITH TIME ZONE NOT NULL);", (e) => { if (e) return console.error(e.stack) });
