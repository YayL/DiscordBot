...
pool.connect((e, client) => {
  ...
  client.query("CREATE TABLE users(id VARCHAR(22) NOT NULL PRIMARY KEY, bal DECIMAL(30,0) DEFAULT 0, job_name VARCHAR(40) NOT NULL DEFAULT 'Unemployed', job_xp BIGINT NOT NULL DEFAULT 0, rebirths INT NOT NULL DEFAULT 0, inventory JSON, achivements JSON, gang VARCHAR(30))", (e) => { if(e) return console.error(e.stack) });
